...
/// PortHandlerWindows, PortHandlerMac, or PortHandlerArduino
////////////////////////////////////////////////////////////////////////////////
...
public:
  ...
  /// @description The function gets class inheritance (PortHandlerLinux /
  /// PortHandlerWindows / PortHandlerMac / PortHandlerArduino.
  ////////////////////////////////////////////////////////////////////////////////
  ...
  /// @description The function calls PortHandlerLinux::setBaudRate() to open
  /// the port.
  ...
  /// @description The function returns current port name set into the port
  /// handler.
  /// @return Port name
  ////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////
  /// @brief The function that returns current baudrate set into the port
  /// handler
  /// @description The function returns current baudrate set into the port
  /// handler.
  /// @return Baudrate
  ////////////////////////////////////////////////////////////////////////////////
  ...
  ////////////////////////////////////////////////////////////////////////////////
  /// @brief The function that checks how much bytes are able to be read from
  /// the port buffer
  /// @description The function checks how much bytes are able to be read from
  /// the port buffer
  ...
  ////////////////////////////////////////////////////////////////////////////////
  /// @brief The function that sets and starts stopwatch for watching packet
  /// timeout
  /// @description The function sets the stopwatch by getting current time and
  /// the time of packet timeout with packet_length.
  ...
  /// timeout
  /// @description The function sets the stopwatch by getting current time and
  /// the time of packet timeout with msec.
  /// @param packet_length Length of the packet expected to be received
  ////////////////////////////////////////////////////////////////////////////////
  ...
  /// @description The function checks whether current time is passed by the
  /// time of packet timeout from the time set by
  /// PortHandlerLinux::setPacketTimeout().
  ////////////////////////////////////////////////////////////////////////////////
